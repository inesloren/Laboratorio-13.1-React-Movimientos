...
import { AccountVm, TransferVm, createEmptyTransferVm, TransferError, createEmptyTransferError } from "../transfer.vm";
...
export const TransferFormComponent:React.FC<Props> = (props) => {
    ...
    React.useEffect(() => {
        if(defaultAccountId){
            setTransfer((prevTransfer) => ({...prevTransfer, accountId: defaultAccountId}));
        }
    }, []);
        ...
        <div>
            <form onSubmit={handleSubmit}>
                <div className={classes.formContainer}>
                    ...
                    <div>
                        <label>Ingreser el IBAN de destino:</label>
                        <input
                            name="iban"
                            onChange={handleFieldChange}
                            className={classes.large}
                    ...
                    <div>
                        <p>
                            Para que la transferencia se realice en otra fecha diferente a la de hoy, por favor, indíquenos la fecha de ejecución:
                        </p>
                    </div>
                    <div>
